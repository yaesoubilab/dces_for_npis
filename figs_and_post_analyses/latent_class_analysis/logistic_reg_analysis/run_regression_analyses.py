...
from fig_support import do_correlation_analysis, plot_logistic_regression_odds, plot_coeffs_both
...
def run_logistic_regression_analysis(vaccine_scenario):
    ...
    plot_logistic_regression_odds(fig_size=(6, 11), vaccine_scenario=vaccine_scenario, x_range=X_RANGE)
...
if __name__ == '__main__':
    ...
    plot_coeffs_both(fig_size=(7, 11), x_range=X_RANGE)